...
<?php include_once("../../app/include/sidebar-admin.php");?>
    <div class="container-fluid">
        ...
        <div class="posts col-9">
            ...
            <h2 class="mx-auto">Редактирование пользователя</h2>
                ...
                <?php include "../../app/helps/errorInfo.php"; ?>
                    ...
                    <input value="<?=$id;?>" name="id" type="hidden">
                        ...
                        <label for="formGroupExampleInput">Логин</label>
                            <input class="form-control" name="login" value="<?=$username?>"
                            type="text" id="formGroupExampleInput" placeholder="Example input"/>                         
                        </div>   

                        <div class="mb-4">
                        <label for="exampleInputEmail1">Email</label> 
                            <input name="email" type="email" value="<?=$email?>" readonly class="form-control"
                        ...
                        <div class="form-group row text-right">
                            <div class="col-12">
                                <button type="submit" name="update-user" class="tm-btn tm-btn-primary tm-btn-small">Обновить</button>                      
                            </div>                           
                        </div>                                
                    </form>
                </form>
